...
func TestClusterScoped(t *testing.T) {
	...
	testHappyCase(t, apiextensionsv1.ClusterScoped, bindv1alpha1.ClusterScope)
}
...
func TestNamespacedScoped(t *testing.T) {
	...
	testHappyCase(t, apiextensionsv1.NamespaceScoped, bindv1alpha1.NamespacedScope)
	// namespaced resource, but with cluster scoped informers
	testHappyCase(t, apiextensionsv1.NamespaceScoped, bindv1alpha1.ClusterScope)
}

func testHappyCase(t *testing.T, resourceScope apiextensionsv1.ResourceScope, informerScope bindv1alpha1.Scope) {
