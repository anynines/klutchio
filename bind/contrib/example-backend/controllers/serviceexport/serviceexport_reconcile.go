...
func (r *reconciler) reconcile(ctx context.Context, export *bindv1alpha1.APIServiceExport) error {
	var errs []error
...
func (r *reconciler) ensureSchema(ctx context.Context, export *bindv1alpha1.APIServiceExport) (specChanged bool, err error) {
	...
	if err != nil {
		conditions.MarkFalse(
			export,
			bindv1alpha1.APIServiceExportConditionProviderInSync,
	...
	if hash := kubebindhelpers.APIServiceExportCRDSpecHash(expected); export.Annotations[bindv1alpha1.SourceSpecHashAnnotationKey] != hash {
		...
		export.Annotations[bindv1alpha1.SourceSpecHashAnnotationKey] = hash
		return true, nil
	}

	conditions.MarkTrue(export, bindv1alpha1.APIServiceExportConditionProviderInSync)
