...
// ExampleBackendV1alpha1Client is used to interact with features provided by the example-backend.klutch.anynines.com group.
...
func setConfigDefaults(config *rest.Config) error {
	gv := examplebackendv1alpha1.SchemeGroupVersion
