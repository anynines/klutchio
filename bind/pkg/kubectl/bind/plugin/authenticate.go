...
func (b *BindOptions) authenticate(provider *bindv1alpha1.BindingProvider, callback, sessionID, clusterID string, urlCh chan<- string) error {
	var oauth2Method *bindv1alpha1.OAuth2CodeGrant
