...
func TestEnsureCRDConditionsCopied(t *testing.T) {
	tests := []struct {
		...
		expected *bindv1alpha1.APIServiceExport
		wantErr  bool
	}{
		{
			name: "merging",
...
func newExport(name string, conditions []conditionsapi.Condition) *bindv1alpha1.APIServiceExport {
	return &bindv1alpha1.APIServiceExport{
		ObjectMeta: metav1.ObjectMeta{
			Name: name,
		},
		Status: bindv1alpha1.APIServiceExportStatus{
			Conditions: conditions,
		},
	}
}
