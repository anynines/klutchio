...
func (r *reconciler) ensureHeartbeat(ctx context.Context, binding *bindv1alpha1.ClusterBinding) error {
...
func (r *reconciler) ensureConsumerSecret(ctx context.Context, binding *bindv1alpha1.ClusterBinding) error {
	...
	if err != nil && !errors.IsNotFound(err) {
		...
		conditions.MarkFalse(
			binding,
			bindv1alpha1.ClusterBindingConditionSecretValid,
...
func (r *reconciler) ensureKonnectorVersion(ctx context.Context, binding *bindv1alpha1.ClusterBinding) error {
	...
	if err != nil {
		...
		conditions.MarkFalse(
			binding,
			bindv1alpha1.ClusterBindingConditionValidVersion,
			"ParseError",
			conditionsapi.ConditionSeverityWarning,
