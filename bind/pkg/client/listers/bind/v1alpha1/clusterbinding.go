...
type ClusterBindingLister interface {
	...
	List(selector labels.Selector) (ret []*bindv1alpha1.ClusterBinding, err error)
...
type clusterBindingLister struct {
	listers.ResourceIndexer[*bindv1alpha1.ClusterBinding]
}
...
func NewClusterBindingLister(indexer cache.Indexer) ClusterBindingLister {
	return &clusterBindingLister{listers.New[*bindv1alpha1.ClusterBinding](indexer, bindv1alpha1.Resource("clusterbinding"))}
}

// ClusterBindings returns an object that can list and get ClusterBindings.
func (s *clusterBindingLister) ClusterBindings(namespace string) ClusterBindingNamespaceLister {
	return clusterBindingNamespaceLister{listers.NewNamespaced[*bindv1alpha1.ClusterBinding](s.ResourceIndexer, namespace)}
}
...
type ClusterBindingNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*bindv1alpha1.ClusterBinding, error)
