...
type ClusterBindingInformer interface {
	...
	Lister() bindv1alpha1.ClusterBindingLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KlutchBindV1alpha1().ClusterBindings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KlutchBindV1alpha1().ClusterBindings(namespace).Watch(context.TODO(), options)
			},
		},
		&apisbindv1alpha1.ClusterBinding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisbindv1alpha1.ClusterBinding{}, f.defaultInformer)
}

func (f *clusterBindingInformer) Lister() bindv1alpha1.ClusterBindingLister {
	return bindv1alpha1.NewClusterBindingLister(f.Informer().GetIndexer())
}
