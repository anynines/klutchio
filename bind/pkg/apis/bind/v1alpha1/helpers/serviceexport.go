...
func ServiceExportToCRD(export *bindv1alpha1.APIServiceExport) (*apiextensionsv1.CustomResourceDefinition, error) {
...
func CRDToServiceExport(crd *apiextensionsv1.CustomResourceDefinition) (*bindv1alpha1.APIServiceExportCRDSpec, error) {
	spec := &bindv1alpha1.APIServiceExportCRDSpec{
	...
	for i := range crd.Spec.Versions {
		...
		apiResourceVersion := bindv1alpha1.APIServiceExportVersion{
...
func APIServiceExportCRDSpecHash(obj *bindv1alpha1.APIServiceExportCRDSpec) string {
