...
consumes depends on the underlying infrastructure we have developed a plugin system so that users
can choose how to best create a path on their infrastructure.
...
To make use of the network connector in your own integrations, please refer to the *TODO* data service integration guide
...
## Crossplane Resources and Documentation

To work effectively with Klutch's network connector, familiarity with Crossplane is valuable:

- **[Crossplane Official Documentation](https://docs.crossplane.io/latest/)** - Complete reference
- **[Crossplane Concepts](https://docs.crossplane.io/latest/concepts/)** - Core concepts and architecture
- **[Composition Authoring Guide](https://docs.crossplane.io/latest/concepts/compositions/)** - How to write effective compositions
- **[Provider Development Guide](https://docs.crossplane.io/latest/software/develop-provider/)** - For creating custom providers
- **[Crossplane Community](https://crossplane.io/community/)** - Support and discussions
...
- Review the [Default Proxy Implementation](./network-connector/proxy.md) to understand how Klutch implements the default network connector
